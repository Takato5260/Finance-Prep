...
const referenceSources = [
    { category: 'Trade Lifecycle & Settlement', categoryJa: 'トレードライフサイクル・決済',
      links: [
        { title: 'Investopedia: Trade Life Cycle', url: 'https://www.investopedia.com/articles/basics/09/trade-life-cycle.asp', desc: 'Overview of the full trade lifecycle from execution to settlement.', descJa: '約定から決済までのトレードライフサイクルの概要。' },
    ...
    { category: 'Regulations & Compliance', categoryJa: '規制・コンプライアンス',
      links: [
        { title: 'SEC: T+1 Settlement FAQ', url: 'https://www.sec.gov/divisions/marketreg/t1-settlement-faq', desc: 'Official SEC guidance on T+1 settlement transition.', descJa: 'T+1決済への移行に関するSECの公式ガイダンス。' },
    ...
    { category: 'Interview Preparation', categoryJa: '面接対策',
      links: [
        ...
        { title: 'Mergers & Inquisitions: Back Office Careers', url: 'https://mergersandinquisitions.com/back-office-careers/', desc: 'Career guide for operations and back office roles.', descJa: 'オペレーション・バックオフィスのキャリアガイド。' },
    ]},
    { category: 'Industry Knowledge', categoryJa: '業界知識',
      links: [
        ...
        { title: 'CME Group: Education', url: 'https://www.cmegroup.com/education.html', desc: 'Free courses on futures, options, and clearing.', descJa: '先物、オプション、清算に関する無料コース。' },
